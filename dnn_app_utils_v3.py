...
def load_data():
    train_dataset = h5py.File('E:/new CV/DL/DL_projects/NN_n_layers/datasets/train_catvnoncat.h5', "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:]) #train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:]) #train set labels

    test_dataset = h5py.File('E:/new CV/DL/DL_projects/NN_n_layers/datasets/test_catvnoncat.h5', "r")
